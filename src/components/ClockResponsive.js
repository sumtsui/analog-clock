...
import './ClockResponsive.style.scss'
import jingyi from '../static/jingyi.jpg'
import haochen from '../static/haochen.jpg'
    ...
    return (
        <div className="clock-container styling">
          <div id="clock" className="clock-content">
            ...
            <img src={jingyi} alt="jingyi" className="img jingyi" />
            ...
            <div
              ...
              className={
                "indicator seconds-indicator" + "transition-effect"
              }
              style={divStyleSeconds}
              >
                <img src={haochen} alt="haochen" className="img haochen " style={divStyleHaochen} />
            </div>
